...
/datum/species/demihuman
	...
	origin = "Grenzelhoft"
	use_titles = TRUE
	race_titles = list("Half-Cat", "Half-Dog", "Half-Wolf", "Half-Lion", "Half-Venard", "Half-Tiger", "Half-Sheep", "Half-Goat", "Half-Rous", "Half-Possum", "Half-Pig", "Half-Boar", "Half-Rabbit", "Half-Horse", "Half-Donkey", "Half-Hyena", "Half-Deer", "Half-Bear", "Half-Panda", "Half-Coyote", "Half-Jackal", "Half-Panther", "Half-Lynx", "Half-Seal", "Half-Bat", "Half-Otter", "Half-Cow", "Half-Bull", "Half-Monster", "Kitsune")
	base_name = "Humen"
